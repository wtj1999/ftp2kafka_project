...
load_dotenv()
from processor.jsonl_to_kafka import send_jsonl_to_kafka_confluent, send_jsonl_to_kafka_confluent1
    ...
    for p in pairs:
        ...
        try:
            ...
            if os.path.exists(step_jsonl):
                ...
                if is_kelie:
                    all_results = result_csv_to_json_kelie(csv_path=local_step, out_jsonl_path=step_jsonl)
                else:
                    all_results = result_csv_to_json(csv_path=local_step, out_jsonl_path=step_jsonl)
